...
def build(traps, ctx, status, pd:root.Product, contexts:typing.Iterable[files.Path], intention:str, cache:files.Path, argv=None, rebuild=False):
	"""
